...
<template>
  <div class="confirmOrder">
    ...
    <el-dialog title="添加收货地址" :visible.sync="dialogVisible" width="40%" :before-close="handleClose">
      <el-form ref="form" :model="form" label-width="80px">
        <el-form-item label="姓名">
          <el-input v-model="form.consignee" placeholder="收货人" size="mini" style="width: 90%;"></el-input>
        </el-form-item>
        <el-form-item label="联系方式">
          <el-input v-model="form.phone" placeholder="联系方式" size="mini" style="width: 90%;"></el-input>
        </el-form-item>
        <el-form-item label="地址">
          <el-col :span="6">
            <el-input v-model="form.province" placeholder="省" size="mini" style="width: 80%;"></el-input>
          </el-col>
          <el-col :span="2">-</el-col>
          <el-col :span="6">
            <el-input v-model="form.city" placeholder="市" size="mini" style="width: 80%;"></el-input>
          </el-col>
          <el-col :span="2">-</el-col>
          <el-col :span="6">
            <el-input v-model="form.county" placeholder="区/县" size="mini" style="width: 80%;"></el-input>
          </el-col>
        </el-form-item>
        <el-form-item label="详细地址">
          <el-input type="textarea" placeholder="详细地址" v-model="form.address" size="mini"
                    style="width: 90%;"></el-input>
        </el-form-item>
        <el-form-item label="邮政编码">
          <el-input v-model="form.mailCode" placeholder="邮政编码" size="mini" style="width: 50%;"></el-input>
        </el-form-item>
        <el-form-item label="备注">
          <el-input v-model="form.note" placeholder="备注" size="mini" style="width: 90%;"></el-input>
        </el-form-item>
        <el-button @click="dialogVisible = false" size="mini">取 消</el-button>
        <el-button type="primary" @click="saveAddress" size="mini">保 存</el-button>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    addOrder() {
      ...
      let acc=0
      let  property=""
      for (property of this.getCheckGoods) {
        acc+=(property.price*property.num)
      }
      re.goodsList=this.getCheckGoods
      re.amount=acc
      re.confirmAddress=this.confirmAddress

      this.$axios
          .post("/goodsOrderApp/saveOrder",re
          )
          .then(res => {
            let products = this.getCheckGoods;
    ...
    getAddress() {
      this.$axios
          ...
          .then(res => {
            this.confirmAddress =
                this.address = res.data.data.dataList
            this.confirmAddress = this.address[0].id
          })
    },
    addAddress(res) {

      this.confirmAddress = res.id
    },
    handleClose() {
    ...
    saveAddress() {
      this.$axios
          .post("/address/saveOrUpdateAddress", this.form
          )
          .then(res => {
            if (res.data.code === 20000) {
              this.notifySucceed(res.data.message);
