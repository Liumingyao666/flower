<template>
  <div class='block'>
    <el-breadcrumb separator='/'>
      ...
      <el-breadcrumb-item>花卉表</el-breadcrumb-item>
      <el-breadcrumb-item>花卉表列表</el-breadcrumb-item>
    </el-breadcrumb>
    <el-card>
      <!-- 搜索 -->
      ...
      <el-table :data='MallGoodsList' border stripe size='mini'
        ...
        <el-table-column prop='goodsName' label='花卉名称'></el-table-column>
        ...
        <el-table-column prop='status' label='花卉状态' width='80' :formatter='statusFormat'></el-table-column>
        <el-table-column prop='goodsOrigin' label='产地' width='80'></el-table-column>
        <el-table-column prop='propagationMethod' label='繁殖方法' width='80'></el-table-column>
        <el-table-column prop='cultivationConditions' label='培育条件' width='80'></el-table-column>
        <el-table-column prop='maintenanceTips' label='养护技巧' width='80'></el-table-column>
        <el-table-column prop='precautions' label='注意事项' width='80'></el-table-column>
        <el-table-column prop='applicationScenarios' label='应用场景' width='80'></el-table-column>
        <el-table-column prop='viewingValue' label='观赏价值' width='80'></el-table-column>
...
<!--        <el-table-column prop='createTime' label='创建时间' width='200'></el-table-column>-->
      ...
      <el-dialog :title='dialogBewrite' :visible.sync='dialogAddMallGoods' width='50%' @close='closeInit'>
        <el-form :model='MallGoodsInfo' ref='addMallGoodsRef' label-width='70px' class='demo-form-inline' size='mini'
          ...
          <el-form-item label='花卉类型'>
            <el-select v-model='MallGoodsInfo.goodsTypeCode' placeholder='请选择花卉类型'>
          ...
          <el-form-item label='状态'>
            ...
            <el-select v-model='MallGoodsInfo.status' placeholder='请选择花卉状态'>
          ...
          <div class='aa'>
            ...
            <el-input v-model='MallGoodsInfo.propagationMethod' type='textarea' :rows='1'></el-input>
          </div>
          <div class='aa'>
            <span>
              培育条件:
            </span>
            <el-input v-model='MallGoodsInfo.cultivationConditions' type='textarea' :rows='1'></el-input>
          </div>
          <div class='aa'>
            <span>
              养护技巧:
            </span>
            <el-input v-model='MallGoodsInfo.maintenanceTips' type='textarea' :rows='1'></el-input>
          </div>
          <div class='aa'>
            <span>
              注意事项:
            </span>
            <el-input v-model='MallGoodsInfo.precautions' type='textarea' :rows='1'></el-input>
          </div>
          <div class='aa'>
            <span>
              应用场景:
            </span>
            <el-input v-model='MallGoodsInfo.applicationScenarios' type='textarea' :rows='1'></el-input>
          </div>
          <div class='aa'>
            <span>
              观赏价值:
            </span>
            <el-input v-model='MallGoodsInfo.viewingValue' type='textarea' :rows='1'></el-input>
          </div>
          ...
          <div class='aa'>
            ...
            <el-input v-model='MallGoodsInfo.goodsAddress' type='textarea' :rows='1'></el-input>
          </div>


          <el-form-item label='标签'>
            <el-select v-model="goodsMarkCode" multiple filterable allow-create default-first-option placeholder="请选花卉商品章标签">
